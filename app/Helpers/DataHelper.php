...
class DataHelper
{
	...
	public static function _normalizeApiParams($params, $created = false, $updated = false, $isNested = false, $deleted = false)
	{
		$return = array();
	 ...
	 * @return null|string
	 */
	public static function getFileNameCloud($file)
	{

		$filename = preg_replace('/\s+/', '_', $file['file_name']->getClientOriginalName());
		$filename = $file['flag'] . '_' . $file['username'] . '_' . time() . '_' . rand() . '.' . pathinfo($filename, PATHINFO_EXTENSION);
	 ...
	 * @return null|string
	 */
	public static function getFilePath($filepdf = false, $fileimg = false)
	{
	...
	public static function getToken(){
		$url = "https://skkm.sttbandung.ac.id/api/getToken";
